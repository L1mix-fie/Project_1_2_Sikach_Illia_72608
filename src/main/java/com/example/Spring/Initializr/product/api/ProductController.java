package com.example.Spring.Initializr.product.api;
...
import com.example.Spring.Initializr.product.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> update(@PathVariable Long id, @RequestBody UpdateProductRequest updateProductRequest) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(productResponse); // Возвращаем 200 OK
    }
    @GetMapping
